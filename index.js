$(function(){
	...
	$(".send").click(function(){
		...
		success:function(msg){
			...
			非标准JSON字符串：
			{error:0, id:1, time :1526542587, acc: 0, ref: 0 }
			标准的JSON字符串：
			{"error":"0", "id":"1", "time" :"1526542587", "acc": "0", "ref": "0" }
			VM179: Uncaught SyntaxError: Unexpected token e in JSON at position
			*/
			var obj = eval("("+msg+")");
			obj.content=$text;
			//根据内容创建节点
